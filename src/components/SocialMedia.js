...
function SocialMedia() {
    return (
        <div className='NotCell'>
            <a className='icon' href='mailto:microcosmosapp@gmail.com'><AiOutlineMail size={32}/></a>
            <a className='icon' href={FaceBook}><AiOutlineFacebook size={32}/></a>
            <a className='icon' href='https://wa.me/5492995289706?text='><BsWhatsapp size={30}/></a>
            <a className='icon' href={Insta} ><AiOutlineInstagram size={32}/></a>
        </div>
    );
}
